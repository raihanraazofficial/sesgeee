...
const getMockData = (type) => {
  const mock = {
    people: [
      ...
      },
      {
        ...
        social_links: {
          ...
          web_of_science: 'https://publons.com/researcher/example2',
        }
      },
      {
        id: '3',
        ...
        social_links: {
          ...
          researchgate: 'https://www.researchgate.net/profile/example3',
          orcid: 'https://orcid.org/0000-0000-0000-0003',
          scopus: 'https://www.scopus.com/authid/detail.uri?authorId=example3',
          web_of_science: 'https://publons.com/researcher/example3',
        }
      }
    ],
    publications: [
    ...
    news: [
      ...
      {
        id: '6',
        title: 'Smart Grid Technologies Conference Successfully Concluded',
        content: '<p>The 2024 Smart Grid Technologies Conference hosted by SESGRG was successfully concluded with participation from over 200 researchers and industry experts.</p><p>The conference featured keynote speeches, technical sessions, and panel discussions on the future of smart grids and renewable energy systems.</p>',
        excerpt: 'SESGRG successfully hosts Smart Grid Technologies Conference with 200+ participants from academia and industry.',
        author: 'Dr. Amirul Islam',
        published_date: '2024-07-20T16:30:00.000Z',
        category: 'events',
        is_featured: true,
        image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzV8MHwxfHNlYXJjaHw4fHxjb25mZXJlbmNlfGVufDB8fHx8MTY5NzAyNzAwMHww&ixlib=rb-4.1.0&q=85',
        image_alt: 'Conference attendees networking',
        tags: ['conference', 'smart grid', 'networking', 'concluded'],
        seo_keywords: 'smart grid conference, technology symposium, research collaboration',
        status: 'published',
        google_calendar_link: ''
      },
      {
        id: '7',
        title: 'International Smart Energy Summit 2025',
        content: '<p>SESGRG is proud to announce participation in the International Smart Energy Summit 2025, scheduled for March 2025 in Dhaka.</p><p>Our research team will present latest findings on sustainable energy solutions and demonstrate cutting-edge microgrid technologies.</p>',
        excerpt: 'SESGRG to participate in International Smart Energy Summit 2025 with presentations and technology demonstrations.',
        author: 'Dr. Shameem Ahmad',
        published_date: '2025-03-10T09:00:00.000Z',
        category: 'upcoming_events',
        is_featured: false,
        image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzV8MHwxfHNlYXJjaHw5fHxzdW1taXR8ZW58MHx8fHwxNjk3MDI3MDAwfDA&ixlib=rb-4.1.0&q=85',
        image_alt: 'International summit venue',
        tags: ['summit', 'international', 'energy', '2025'],
        seo_keywords: 'energy summit, international conference, smart energy',
        status: 'published',
        google_calendar_link: 'https://calendar.google.com/calendar/embed?src=summit2025'
      },
      {
        id: '8',
        title: 'Research Collaboration with European Universities Established',
        content: '<p>SESGRG has established formal research collaboration agreements with leading European universities specializing in sustainable energy research.</p><p>This partnership will facilitate joint research projects, student exchanges, and shared access to advanced research facilities.</p>',
        excerpt: 'SESGRG forms strategic research partnerships with European universities for joint sustainable energy projects.',
        author: 'Dr. A. S. Nazmul Huda',
        published_date: '2024-07-15T14:20:00.000Z',
        category: 'news',
        is_featured: true,
        image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzV8MHwxfHNlYXJjaHwxMHx8cGFydG5lcnNoaXB8ZW58MHx8fHwxNjk3MDI3MDAwfDA&ixlib=rb-4.1.0&q=85',
        image_alt: 'International collaboration handshake',
        tags: ['collaboration', 'european', 'partnership', 'research'],
        seo_keywords: 'research collaboration, european universities, partnership',
        status: 'published',
        google_calendar_link: ''
      }
    ],
    settings: {
      ...
      google_calendar_url: 'https://calendar.google.com/calendar/embed?src=en.bd%23holiday%40group.v.calendar.google.com&ctz=Asia%2FDhaka'
    },
  };
  return mock[type] || [];
};
  ...
  const fetchData = useCallback(async (type, params = {}) => {
    try {
      ...
      try {
        ...
        // If Firestore returns empty data, use mock data fallback (but not for projects - show empty for real-time admin panel updates)
        if (data.length === 0 && type !== 'events' && type !== 'projects') {
