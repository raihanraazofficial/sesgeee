        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold font-heading text-white">SESGRG</span>
              <span className="text-xs text-gray-400 hidden sm:block">Sustainable Energy & Smart Grid Research</span>
            </div>
          </Link>
