        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-heading text-gray-900 leading-tight">Sustainable Energy & Smart Grid</span>
              <span className="text-sm font-heading text-gray-900 leading-tight">Research Group</span>
            </div>
          </Link>
