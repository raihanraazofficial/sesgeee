...
class SESGRGAPITester:
    def __init__(self, base_url="https://login-network-debug.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://login-network-debug.preview.emergentagent.com")
