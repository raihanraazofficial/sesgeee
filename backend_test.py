...
class SESGRGAPITester:
    def __init__(self, base_url="https://sustainable-site-mod.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://sustainable-site-mod.preview.emergentagent.com")
