...
class SESGRGAPITester:
    def __init__(self, base_url="https://logo-integration-9.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://logo-integration-9.preview.emergentagent.com")
