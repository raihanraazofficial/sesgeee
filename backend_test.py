...
class SESGRGAPITester:
    def __init__(self, base_url="https://clean-energy-web-fix.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://clean-energy-web-fix.preview.emergentagent.com")
