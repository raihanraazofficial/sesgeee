...
class SESGRGAPITester:
    def __init__(self, base_url="https://people-page-upgrade.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://people-page-upgrade.preview.emergentagent.com")
