...
class SESGRGAPITester:
    def __init__(self, base_url="https://website-content-mod.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://website-content-mod.preview.emergentagent.com")
