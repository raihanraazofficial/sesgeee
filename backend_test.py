...
class SESGRGAPITester:
    def __init__(self, base_url="https://website-redesign-2.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://website-redesign-2.preview.emergentagent.com")
