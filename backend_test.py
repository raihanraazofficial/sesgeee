...
class SESGRGAPITester:
    def __init__(self, base_url="https://dynamic-calendar-1.preview.emergentagent.com"):
...
def main():
    ...
    # Setup
    tester = SESGRGAPITester("https://dynamic-calendar-1.preview.emergentagent.com")
